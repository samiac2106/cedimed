...
?>
	<section id="container">
		<center><h1 style="text-transform: uppercase;"> <?php if ($_SESSION['sexo']=='hombre'){echo 'Bienvenido '.$_SESSION['nombre'].' al sistema de copagos';}else{echo 'Bienvenida '.$_SESSION['nombre'].' al sistema de copagos';};?></h1>
		<br><br>
