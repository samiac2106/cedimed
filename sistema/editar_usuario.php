...
<head>
    ...
    <title>ACTUALIZACION EMPLEADO</title>
...
<a href="menu.php" class="btn_new" style="position:fixed ; top:350px; left: 0;">Editar Menú</a>
       ...
       <h1>Actualización de Empleados</h1>
        ...
        <div>
            ...
            <input type="text" name="identificacion" id="identificacion" placeholder="Ingrese N° Identificación" autocomplete="off" value="<?php echo $identificacion;?>">
        </div>
        <div>
        ...
        <div>
            ...
            <input type="password" name="clave" id="nombre" placeholder="Clave de Acceso" autocomplete="off" value="<?php echo $clave;?>">
        </div>
        <div>
