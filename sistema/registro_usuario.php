    ...
    if(!empty($_POST)){
        ...
        || empty($_POST['clave'])  || empty($_POST['rol']) || empty($_POST['sexo'])){
            ...
            if ($result>0){
                ...
                $query_insert = mysqli_query($conexion,"INSERT INTO usuario(nombre,cedula,usuario,clave,rol, sexo)
                                                            value('$nombre','$identificacion','$usuario','$clave','$rol','$sexo')");
                if($query_insert){
    ...
    <a href="menu.php" class="btn_new" style="position:fixed ; top:350px; left: 0;">Editar Menú</a>
       ...
       <h1>Registro de Empleados</h1>
        ...
        <div>
            ...
            <input type="text" name="nombre" id="nombre" placeholder="Ingrese Nombre y Apellido" autocomplete="off">
        </div>
        <div>
            <label for="identificacion">Identificación</label>
            <input type="text" name="identificacion" id="identidicacion" placeholder="Ingrese N° Identificación" autocomplete="off">
        </div>
        <div>
        ...
        <div>
            ...
            <input type="password" name="clave" id="nombre" placeholder="Clave de Acceso" autocomplete="off">
        </div>
        <div>
