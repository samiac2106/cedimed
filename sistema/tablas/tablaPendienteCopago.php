      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="card-box table-responsive">
            ...
            Aquí se encuentra todas las citas pendientes de todos los asesores
            </p>
            <table id="datatable" class="table table table-hover table-bordered" style="width:100%">
              ...
              ci.identificacion, ci.tipo_doc,  ci.telefono, ent.id as id_entidad, est.id_estudio, est.nombre_estudio, ent.nombre as 'entidad', ci.vigencia_orden,
               ci.arl_codigo, ci.fecha_cita,us.nombre as 'asesor', ci.observaciones, esta.estado, estc.estado as 'estado_cita',
                ad.estado as 'estado_admision', ad.num_cita,ad.cod_autorizacion, ad.copago, ad.valor_copago, ad.observaciones
                 ...
                 ci.observaciones_pendiente, usu.nombre as 'usuario_actualizacion', ci.fecha_actualizacion
                FROM cita ci 
              ...
              INNER JOIN usuario usua ON usua.idusuario=ad.usuario_admisiones
               INNER JOIN estado_admisiones esta ON esta.id=ad.estado WHERE ci.estadocita=1";
              }else{
                $consultaSQL = "SELECT ci.nro_cita, ci.fecha, ci.nombre as 'nombre_paciente', td.tipo,
              ci.identificacion, ci.tipo_doc,  ci.telefono, ent.id as id_entidad, est.id_estudio, est.nombre_estudio, ent.nombre as 'entidad', ci.vigencia_orden,
               ci.arl_codigo, ci.fecha_cita,us.nombre as 'asesor', ci.observaciones, esta.estado, estc.estado as 'estado_cita',
              ...
              INNER JOIN usuario usu ON usu.idusuario=ci.usuario_actualizacion
              INNER JOIN usuario usua ON usua.idusuario=ad.usuario_admisiones
               INNER JOIN estado_admisiones esta ON esta.id=ad.estado WHERE ci.estadocita=1 AND ci.usuario=$usuario_id";
              }
              ...
              ?>
                <tr>
                  ...
                  <td><a href="" data-toggle="modal" data-target="#modalGestion<?php echo $copago['nro_cita'] ?>" class="text-info font-weight-bold"><?php echo $copago['observaciones_pendiente']; ?></a></td>
                ...
                <!-- Modal Ver Actualizacion gestion-->
                <div class="modal fade" id="modalGestion<?php echo $copago['nro_cita'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Información de la Gestion</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div>
                      <div class="modal-body">
                        ...
                        <div class="row">
                          <div class="col-6">Gestión</div>
                          <div class="col-6"><?php echo $copago['observaciones_pendiente'] ?></div>
                        </div>
                        <div class="row">
                          <div class="col-6">Usuario Que Gestionó</div>
                          <div class="col-6"><?php echo $copago['usuario_actualizacion'] ?></div>
                        </div>
                        <div class="row">
                          <div class="col-6">Fecha Que Se Gestionó</div>
                          <div class="col-6"><?php echo $copago['fecha_actualizacion'] ?></div>
                        </div>
