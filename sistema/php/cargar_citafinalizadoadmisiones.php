...
if (!empty($_POST)){
    ...
    if($_POST['action']=='cita_finalizadoad')
    {  
        
         $nro_cita=$_POST['cita_finalizadoad'];
...
/* print_r($_POST);
        exit; */ 
    if($_POST['action']=='addFinalizadoad')
    {  
         
        if (!empty($_POST['cita_finalizadoad'])){
            $nro_cita=$_POST['cita_finalizadoad'];
            $finalizado=$_POST['txtfinalizadoad'];
            $codaut=$_POST['codaut'];
            $copago=$_POST['copago'];
            $valor=$_POST['valor'];
