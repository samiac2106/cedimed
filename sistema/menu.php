...
?>
       ...
       <h1>Modificación de Innformación en el Menú</h1>
        <hr>
        <div class="alert"><?php echo isset($alert) ? $alert : '';?></div>
        <div >
            <h3><div for="">Información 1</div>
            <input type="text" name="titulo1" id="titulo1" class="titulo1" value="<?php echo $data1['titulo']?>"></h3>
              <textarea style="text-align: justify;text-transform: none !important;"name="descripcion1" id="descripcion1" cols="30" rows="10"><?php echo $data1['descripcion']?></textarea> 
        </div>
        <div>
            <h3><div for="">Información 2</div>
            <input type="text" name="titulo2" id="titulo2" class="titulo2" value="<?php echo $data2['titulo']?>"></h3>
              <textarea style="text-align: justify;text-transform: none !important;" name="descripcion2" id="descripcion2" cols="30" rows="10"><?php echo $data2['descripcion']?> </textarea>
        </div>
        <div >
            <h3><div for="">Información 3</div>
            <input type="text" name="titulo3" id="titulo3" class="titulo3" value="<?php echo $data3['titulo']?>"></h3>
              <textarea style="text-align: justify;text-transform: none !important;" name="descripcion3" id="descripcion3" cols="30" rows="10"><?php echo $data3['descripcion']?></textarea> 
        </div>
